...
class Easyjobs_Helper {
	 ...
	 * @return false|string
	 */
	public static function job_filter($jobs, $settings = array()){
		ob_start();
		?>
			...
			<?php if ( (isset($settings['easyjobs_job_filter_by_category_control']) && $settings['easyjobs_job_filter_by_category_control'] === 'yes')): ?>
	            <div class="select-option">
	                <select name="job_category">
						...
						<?php foreach (self::get_categories($jobs, $settings['easyjobs_show_open_job']) as $category): ?>
	                        <option value="<?php echo esc_html($category['id'])?>"><?php echo esc_html($category['name']); ?></option>
						<?php endforeach;?>
	                </select>
	            </div>
			<?php endif; ?>
			<?php if ( (isset($settings['easyjobs_job_filter_by_title_control']) && $settings['easyjobs_job_filter_by_title_control'] === 'yes') || (isset($settings['easyjobs_job_filter_by_category_control']) && $settings['easyjobs_job_filter_by_category_control'] === 'yes')): ?>
